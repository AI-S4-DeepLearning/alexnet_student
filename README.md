...
- plotter.py: functionaliteit voor het plotten van de figuren.
...
3. Analyseeer in main.ipynb de klasseverdeling
4. Kies in main.ipynb goede parameterwaarden om grid search over uit te voeren.
5. Analyseer de resultaten van gridsearch en trek conclusies.
6. De gegeven dataset is niet gebalanceerd. De minder vertegenwoordigde ziekten zullen wellicht minder goed voorspeld worden. Implementeer de klasse BalancedDataset in datasetgenerator.py en pas deze toe.
7. Doe een tweede iteratie, maar nu met de gebalanceerde dataset. Vergelijk je resultaten en trek conclusies

De volgende uitbreidingen zijn bijvoorbeeld mogelijk voor deze opdracht:

6. (optioneel) Analyseer de data kwalitatief (bijvoorbeeld met Gradient-weighted Class Activation Mapping). Gebruik de resultaten om beter uit te kunnen leggen waarom sommige misclassificaties voorkomen. Bedenk zelf hoe.
